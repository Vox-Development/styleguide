...
(defn typography []
  [:section {:id "typography" :class "huge-module anchor clearfix"}
	 ...
	 [:p {:class "p2"} "Link volume is one of the most powerful signals search engines use to rank websites. 
                    There’s a\n way to use links to generate better search results, but too many marketers 
                    rely on traditional (or even\n black hat) tactics that just don’t work anymore."]
